...
import frozenbubble.net.library.jiga.*;
...
public class LaunchBubbleSprite extends Sprite {
    ...
    public LaunchBubbleSprite(GameApplet applet, int initialColor, int initialDirection) {
        ...
        if (backgroundImage == null || spritesImage == null) {
            ...
            backgroundImage = new BufferedImage(86, 3116, BufferedImage.TYPE_INT_RGB);
            spritesImage = new BufferedImage(256, 1312, BufferedImage.TYPE_INT_RGB);
            spritesBlindImage = new BufferedImage(256, 1312, BufferedImage.TYPE_INT_RGB);
