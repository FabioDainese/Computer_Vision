...
public class XmlRequest implements Runnable {
	 ...
	 * @param method Must be POST or GET. Set to POST if not understood
	 * @param url url to call (Will be completed with the codebase value)
	 * @param async defines asynchronous call
	 */
	...
	/**
	 * Calls server.  
	 * @param data form parameters, concatened to url (GET) or added to body (POST)
	 */
