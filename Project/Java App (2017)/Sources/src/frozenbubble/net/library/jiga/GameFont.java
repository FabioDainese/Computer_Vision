...
public class GameFont {
     ...
     * @param fontMap the Image representing all the characters of the set
     * @param characters The set of <code>char</code> represented by the font
     * @param position The X position (pixel) of the end of the character 
     ...
     * @param characters The set of <code>char</code> represented by the font
     * @param position The X position (pixel) of the end of the character (See details in constructor)
     */
